...
import { getOneUserByIdOrDni, getAllUsers, getUsersByRol, register, updateUser, deleteUserById } from './usersController.js';
...
usersRouter.delete('/delete', verifyToken, authorizeRoles(["Admin", "Trabajador"]), deleteUserById);
